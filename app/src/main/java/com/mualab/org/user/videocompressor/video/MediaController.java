package com.mualab.org.user.videocompressor.video;
...
import com.mualab.org.user.videocompressor.Config;
...
//    public boolean convertVideo(final String path) {
    public String convertVideo(final String path) {
        ...
        Log.d(TAG, "convertVideo: convert width: " + width);
        Log.d(TAG, "convertVideo: convert height: " + height);
        Log.d(TAG, "convertVideo: convert rotation: " + rotation);

        long startTime = -1;
        long endTime = -1;

        int resultWidth = 960;
        int resultHeight = 540;
...
//        int bitrate = 450000;
        int bitrate = 3500000; //3,500 kbps
        int rotateRender = 0;
        ...
        Log.d(TAG, "convertVideo: cache file: " + cacheFile.getPath());
