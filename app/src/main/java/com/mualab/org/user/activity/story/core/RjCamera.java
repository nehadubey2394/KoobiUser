...
public class RjCamera {
    ...
    public RjCamera(@NonNull Activity context) {
        mContext = context;
        mActivityContext = context;
        mPrimaryColor = DialogUtils.resolveColor(context, R.attr.colorPrimary);
    }

    public RjCamera(@NonNull android.app.Fragment context) {
        mIsFragment = true;
    ...
    public RjCamera(@NonNull android.support.v4.app.Fragment context) {
        mIsFragment = true;
    ...
    public RjCamera countdownMillis(long lengthLimitMs) {
        mLengthLimit = lengthLimitMs;
        return this;
    }

    public RjCamera countdownSeconds(float lengthLimitSec) {
        return countdownMillis((int) (lengthLimitSec * 1000f));
    }

    public RjCamera countdownMinutes(float lengthLimitMin) {
        return countdownMillis((int) (lengthLimitMin * 1000f * 60f));
    }

    public RjCamera allowRetry(boolean allowRetry) {
        mAllowRetry = allowRetry;
        return this;
    }

    public RjCamera autoSubmit(boolean autoSubmit) {
        mAutoSubmit = autoSubmit;
        return this;
    }

    public RjCamera countdownImmediately(boolean immediately) {
        mCountdownImmediately = immediately;
        return this;
    }

    public RjCamera saveDir(@Nullable File dir) {
        if (dir == null) return saveDir((String) null);
        return saveDir(dir.getAbsolutePath());
    }

    public RjCamera saveDir(@Nullable String dir) {
        mSaveDir = dir;
        return this;
    }

    public RjCamera primaryColor(@ColorInt int color) {
        mPrimaryColor = color;
        return this;
    }

    public RjCamera primaryColorRes(@ColorRes int colorRes) {
        return primaryColor(ContextCompat.getColor(mContext, colorRes));
    }

    public RjCamera primaryColorAttr(@AttrRes int colorAttr) {
        return primaryColor(DialogUtils.resolveColor(mContext, colorAttr));
    }

    public RjCamera showPortraitWarning(boolean show) {
        mShowPortraitWarning = show;
        return this;
    }

    public RjCamera allowChangeCamera(boolean allowChangeCamera) {
        mAllowChangeCamera = allowChangeCamera;
        return this;
    }

    public RjCamera defaultToFrontFacing(boolean frontFacing) {
        mDefaultToFrontFacing = frontFacing;
        return this;
    }

    public RjCamera retryExits(boolean exits) {
        mRetryExists = exits;
        return this;
    }

    public RjCamera restartTimerOnRetry(boolean restart) {
        mRestartTimerOnRetry = restart;
        return this;
    }

    public RjCamera continueTimerInPlayback(boolean continueTimer) {
        mContinueTimerInPlayback = continueTimer;
        return this;
    }

    public RjCamera forceCamera1() {
        mForceCamera1 = true;
        return this;
    }

    public RjCamera audioDisabled(boolean disabled) {
    ...
    @Deprecated
    public RjCamera videoBitRate(@IntRange(from = 1, to = Integer.MAX_VALUE) int rate) {
        return videoEncodingBitRate(rate);
    }

    public RjCamera videoEncodingBitRate(@IntRange(from = 1, to = Integer.MAX_VALUE) int rate) {
        mVideoEncodingBitRate = rate;
        return this;
    }

    public RjCamera audioEncodingBitRate(@IntRange(from = 1, to = Integer.MAX_VALUE) int rate) {
        mAudioEncodingBitRate = rate;
        return this;
    }

    public RjCamera videoFrameRate(@IntRange(from = 1, to = Integer.MAX_VALUE) int rate) {
        mVideoFrameRate = rate;
        return this;
    }

    public RjCamera videoPreferredHeight(
            @IntRange(from = 1, to = Integer.MAX_VALUE) int height) {
        mVideoPreferredHeight = height;
        return this;
    }

    public RjCamera videoPreferredAspect(
            @FloatRange(from = 0.1, to = Float.MAX_VALUE) float ratio) {
        mVideoPreferredAspect = ratio;
        return this;
    }

    public RjCamera maxAllowedFileSize(long size) {
        mMaxFileSize = size;
        return this;
    }

    public RjCamera qualityProfile(@RjCamera.QualityProfile int profile) {
        mQualityProfile = profile;
        return this;
    }

    public RjCamera iconRecord(@DrawableRes int iconRes) {
        mIconRecord = iconRes;
        return this;
    }

    public RjCamera iconStop(@DrawableRes int iconRes) {
        mIconStop = iconRes;
        return this;
    }

    public RjCamera iconFrontCamera(@DrawableRes int iconRes) {
        mIconFrontCamera = iconRes;
        return this;
    }

    public RjCamera iconRearCamera(@DrawableRes int iconRes) {
        mIconRearCamera = iconRes;
        return this;
    }

    public RjCamera iconPlay(@DrawableRes int iconRes) {
        mIconPlay = iconRes;
        return this;
    }

    public RjCamera iconPause(@DrawableRes int iconRes) {
        mIconPause = iconRes;
        return this;
    }

    public RjCamera iconRestart(@DrawableRes int iconRes) {
        mIconRestart = iconRes;
        return this;
    }

    public RjCamera labelRetry(@StringRes int stringRes) {
  ...
  */
    public RjCamera labelUseVideo(@StringRes int stringRes) {
        mLabelConfirm = stringRes;
        return this;
    }

    public RjCamera labelConfirm(@StringRes int stringRes) {
        mLabelConfirm = stringRes;
        return this;
    }

    /** Will take a still shot instead of recording. */
    public RjCamera stillShot() {
        mStillShot = true;
        return this;
    }

    public RjCamera autoRecordWithDelayMs(
            @IntRange(from = -1, to = Long.MAX_VALUE) long delayMillis) {
        mAutoRecord = delayMillis;
        return this;
    }

    public RjCamera autoRecordWithDelaySec(
    ...
    public Intent getIntent() {
        Intent intent = new Intent(mContext, CaptureStoreActivity.class)
