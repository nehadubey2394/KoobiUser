...
import com.mualab.org.user.activity.make_booking.adapter.BookingInfoAdapter;
import com.mualab.org.user.activity.make_booking.adapter.TimeSlotAdapter;
import com.mualab.org.user.activity.make_booking.background_service.ExpiredBookingJobService;
import com.mualab.org.user.activity.make_booking.listner.DeleteServiceListener;
        ...
        switch (view.getId()) {
            case R.id.btnCOnfirmBooking:
                ...
                if (bookingTimeSlots.size() != 0 || !bookingInfo.date.equals("Select date") && !bookingInfo.time.equals("and time")){
                    ...
                    MyToast.getInstance(mContext).showDasuAlert("There is no time slot available, select another date for make_booking");
