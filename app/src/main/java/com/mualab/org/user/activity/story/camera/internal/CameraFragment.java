package com.mualab.org.user.activity.story.camera.internal;
...
import com.mualab.org.user.activity.story.camera.util.Degrees;
import com.mualab.org.user.activity.story.camera.util.ImageUtil;
import com.mualab.org.user.activity.story.camera.util.ManufacturerUtil;
...
import static com.mualab.org.user.activity.story.camera.internal.BaseCaptureActivity.CAMERA_POSITION_BACK;
import static com.mualab.org.user.activity.story.camera.internal.BaseCaptureActivity.CAMERA_POSITION_FRONT;
import static com.mualab.org.user.activity.story.camera.internal.BaseCaptureActivity.CAMERA_POSITION_UNKNOWN;
import static com.mualab.org.user.activity.story.camera.internal.BaseCaptureActivity.FLASH_MODE_ALWAYS_ON;
import static com.mualab.org.user.activity.story.camera.internal.BaseCaptureActivity.FLASH_MODE_AUTO;
import static com.mualab.org.user.activity.story.camera.internal.BaseCaptureActivity.FLASH_MODE_OFF;
