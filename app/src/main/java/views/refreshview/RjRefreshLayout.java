...
public class RjRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    private static final String TAG = RjRefreshLayout.class.getSimpleName();
    ...
    public RjRefreshLayout(Context context) {
        this(context, null);
    }
...
//                break;
    ...
    /**
     * call this method to make {@link #RjRefreshLayout} know the refresh is over.
    ...
    /**
     * call this method to make {@link #RjRefreshLayout} know this refresh is over.
     *
